...
7. <font color=red>（3.3.20 双射）</font>同时是单射与满射的函数$f:X\to Y$也可被称为双射函数或__可逆函数__，对于一个双射，可以将$x$的值记为$f^{-1}(y)$，于是$f^{-1}$是一个从$Y$到$X$的函数，称$f^{-1}$为$f$的逆。
