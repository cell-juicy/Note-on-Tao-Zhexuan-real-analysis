...
##### 3.6.8 设$$A$$与$$B$$是集合，且存在一个从$$A$$到$$B$$的单射$$f:A\rightarrow B$$（也即集合$$A$$的基数小于或等于集合$$B$$的基数），证明：存在一个从$$B$$到$$A$$的满射$$g:B\rightarrow A$$<font color=blue>（该命题的逆命题证明需要用到选择公理，详情参考习题8.4.3）</font>
