...
> $$
> \begin{gather}
> \exist\:\delta>0,\forall\:\pi/2-\delta_1<x\wedge|x-\pi/2|<\delta,\tan(x)>\frac{1}{2\cos(x)}>|M|\geq M\\
> \exist\:\delta>0,\forall\:-\pi/2+\delta_2>x\wedge|x-(-\pi/2)|<\delta,\tan(x)<-\frac{1}{2\cos(x)}<-|M|\leq M\\
> \end{gather}
> $$
