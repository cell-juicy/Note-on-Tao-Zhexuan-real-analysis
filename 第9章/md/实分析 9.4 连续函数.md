...
##### 9.4.3 证明命题9.4.10<font color=blue>（提示：你可以把[引理6.5.3](..\..\第6章\pdf\实分析 6.5 一些基本的极限.pdf)，[夹逼定理（推论6.4.14）](..\..\第6章\pdf\实分析 6.4 上极限、下极限和极限点.pdf)以及[命题6.7.3](..\..\第6章\pdf\实分析 6.7 实数的指数运算 II.pdf)结合起来使用）</font>
...
##### 9.4.4 证明命题9.4.11<font color=blue>（提示：利用极限定律（[命题9.3.14](..\..\第9章\pdf\实分析 9.3 函数的极限值.pdf)）可以证明$\displaystyle\lim_{x\to 1}x^n=1$对所有的整数$n$都成立。利用这个命题和[夹逼定理](..\..\第6章\pdf\实分析 6.4 上极限、下极限和极限点.pdf)推导出$\displaystyle\lim_{x\to 1}x^p=1$对所有的实数$p$都成立。最后，使用[命题6.7.3](..\..\第6章\pdf\实分析 6.7 实数的指数运算 II.pdf)）</font>
