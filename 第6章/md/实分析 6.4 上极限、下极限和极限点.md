...
##### 6.4.2 对于极限点、上极限、下极限，叙述并证明与[习题6.1.3](..\..\第6章\pdf\实分析 6.1 收敛与极限定律.pdf)和[习题6.1.4](..\..\第6章\pdf\实分析 6.1 收敛与极限定律.pdf)类似的结论
...
> \sup(A_N^-)_{N=m}^\infty\leq\sup(B_N^-)_{N=m}^\infty
> $$
> 再根据定义6.4.6，于是即当$a_n\leq b_n$对全部$n\geq m$成立，则有$\displaystyle\lim\sup_{n\rightarrow \infty}a_n\leq\lim\sup_{n\rightarrow \infty}b_n$与$\displaystyle\lim\inf_{n\rightarrow \infty}a_n\leq\lim\inf_{n\rightarrow \infty}b_n$成立，于是上下极限的比较原理得证。
>
> 综上，于是命题得证。
...
> 令有$L^+=\lim \sup\limits_{n\rightarrow\infty}a_n$，$L^-=\lim \inf\limits_{n\rightarrow\infty}a_n$，先给出上极限的相关证明，下极限在上极限的证明基础上稍作修改即可。
>
> 证明：$\lim \sup\limits_{n\rightarrow\infty}a_n$ 是$(a_n)_{n=m}^\infty$的一个极限点，并且它比$(a_n)_{n=m}^\infty$的其他任何极限点都大
>
> 先证明上极限是极限点：
>
...
[实分析 6.1 收敛与极限定律](..\..\第6章\pdf\实分析 6.1 收敛与极限定律.pdf)